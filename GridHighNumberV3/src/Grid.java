...
public class Grid extends JFrame implements MouseListener {
    ...
    public void paint(Graphics g)
    {
        ...
        {
            g.drawString("GAME OVER: " + this.grid.get_winner()
            + "     Player: " + this.grid.get_player_score()
            + "     Bot: " + this.grid.get_bot_score()
            , this.margin_left, this.margin_top / 2);
        }
        else
        {
            g.drawString("Player: " + this.grid.get_player_score(), this.margin_left, this.margin_top / 2);
            g.drawString("Bot: " + this.grid.get_bot_score(), this.getSize().width / 2, this.margin_top / 2);
        }
    }
